...
function applyLeaderHead(html: string): string {
  ...
  next = replaceOnce(
    next,
    'content="Cortex Crew, Team Cortex Crew, Daffodil International University, DIU, hackathon team Bangladesh, project showcase, Kawsher HRidoy, Shafiur Rahman Shafim, Arnob Kumar Paul, AL Fahad, Abdullah Al Khalil, Arvin Ahmed Alok, CSAD 2026, IEEE ICADHI 2026, Dhaka"',
